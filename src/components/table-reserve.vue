                  ...
                  <div class="card-body">
                    ...
                    <b-form class="form-box px-3">
                      <div class="form-input">
                        ...
                        <input placeholder="Select any time today in 24hr format" class="textbox-n" type="number" onfocus="(this.type='number')" onfocusout="(this.type='text')" id="date" v-model="datetime" required/>
                      </div>
                      <div class="form-input">
